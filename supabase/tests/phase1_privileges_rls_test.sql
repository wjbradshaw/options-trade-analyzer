...
select throws_ok(
  $$
    insert into public.entry_analyses (
      ...
      '11111111-1111-1111-1111-111111111111',
      '33333333-3333-3333-3333-333333333333', false, 'Wait', 1, now()
    )
  $$,
  '23514',
  null,
  'an analysis cannot bypass the confirmed-contract gate'
);
...
select throws_ok(
  $$
    insert into public.watch_candidates (
      ...
      '44444444-4444-4444-4444-444444444444', 'Consider',
      '44444444-4444-4444-4444-444444444444'
    )
  $$,
  '23514',
  null,
  'a watch candidate source analysis must be Wait'
);
